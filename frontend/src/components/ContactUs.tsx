...
export default function ContactUs() {
    ...
    return (
        <section id="contact" className="jms js_section" ref={sectionRef}>
            <div className="jms_ttl_wrap" style={{ flexWrap: 'wrap' }}>
                <h2 className="jms_ttl">
                    ...
                    <span className="sr_only">Contact Us</span>
                </h2>
                <div className="jms_info">
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '30px' }}>
                        ...
                        <div>
                            <p className="history_txt" style={{ fontSize: '14px', textTransform: 'uppercase', letterSpacing: '0.05em', marginBottom: '8px', opacity: 0.7, color: 'white' }}>Address</p>
                            <p className="jms_info_ttl" style={{ fontSize: '20px', color: 'white' }}>
